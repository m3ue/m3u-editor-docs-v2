...
export const WIZARD_SECTIONS = [
  ...
  },
  {
    ...
    variables: [
      ...
      {
        name: 'HLS_BROADCAST_DIR',
        label: 'HLS Broadcast Directory',
        description: 'Container directory for network broadcast HLS segments. Defaults to /dev/shm (RAM disk) for low-latency live TV. Segments are ephemeral and benefit from in-memory storage.',
        type: FIELD_TYPES.TEXT,
        default: '/dev/shm',
        placeholder: '/dev/shm',
        deploymentTypes: ['modular', 'aio', 'vpn', 'external-nginx', 'external-caddy'],
  ...
  },
  {
    ...
    variables: [
      ...
      },
      {
        ...
        description: 'Enable OpenID Connect Single Sign-On authentication (Keycloak, Authelia, Authentik, etc.)',
        type: FIELD_TYPES.BOOLEAN,
        default: false,
        deploymentTypes: ['modular', 'aio', 'vpn', 'external-nginx', 'external-caddy'],
      },
      {
        ...
        description: 'Base URL of your OIDC identity provider (excluding /.well-known/openid-configuration)',
        type: FIELD_TYPES.TEXT,
        default: '',
        placeholder: 'https://auth.example.com/realms/myrealm',
        showWhen: { field: 'OIDC_ENABLED', value: true },
        deploymentTypes: ['modular', 'aio', 'vpn', 'external-nginx', 'external-caddy'],
      },
      {
        name: 'OIDC_CLIENT_ID',
  ...
  },
  {
    ...
    variables: [
      ...
      {
        name: 'HLS_TEMP_DIR_HOST',
        label: 'HLS Segments Volume',
        description: 'Host path to mount for HLS segment storage. For AIO/embedded proxy: mounts into the editor container. For external proxy: mounts into the proxy container. Leave empty to use container storage only (optional)',
        type: FIELD_TYPES.TEXT,
        default: '',
        placeholder: '/path/to/hls-segments',
        deploymentTypes: ['modular', 'aio', 'vpn', 'external-nginx', 'external-caddy'],
      },
      {
        name: 'HLS_BROADCAST_DIR_HOST',
        label: 'HLS Broadcast Volume',
        description: 'Host path to mount for broadcast HLS segment storage. For AIO/embedded proxy: mounts into the editor container. For external proxy: mounts into the proxy container. Leave empty to use container storage only (optional)',
        type: FIELD_TYPES.TEXT,
        default: '',
        placeholder: '/path/to/hls-broadcasts',
        deploymentTypes: ['modular', 'aio', 'vpn', 'external-nginx', 'external-caddy'],
      },
    ],
  },
